  ...
  return (
    <div className={styles.hlWidget}>
      ...
      <div className={styles.hlAvatars}>
        <img className={styles.hlAvatar} style={{ position: "relative", zIndex: 3 }} src={Person1} alt="Person 1" />
        <img className={styles.hlAvatar} style={{ position: "relative", zIndex: 2 }} src={Person2} alt="Person 2" />
        <img className={styles.hlAvatar} style={{ position: "relative", zIndex: 1 }} src={Person3} alt="Person 3" />
      </div>

      <h2 className={styles.hlTitle}>How can we help ?</h2>

      <div className={styles.hlOption} role="button" tabIndex={0}>
      ...
      <div className={styles.hlOption} role="button" tabIndex={0}>
        ...
        <img className={styles.hlOptionIcon} src={MessageIcon} alt="Message Icon" />
      </div>
    </div>
  );
};
