        ...
        {options.map(option => {
          ...
          return (
            <MenuItem key={option.key}>
              ...
              >
                <span>{option.longLabel || option.label}</span>
                <span className={menuItemBorderClass}>
                  <span className={css.menuItemBorderIcon}></span>
                </span>
              </button>
            </MenuItem>
          );
