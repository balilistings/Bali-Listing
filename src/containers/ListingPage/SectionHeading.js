...
import { isFieldForListingType, pickCustomFieldProps, isFieldForCategory, pickCategoryFields } from '../../util/fieldHelpers';
...
const SectionHeading = props => {
  const { publicData, metadata = {}, listingFieldConfigs, intl, categoryConfiguration, location } = props;
    ...
    <>
      ...
      <div className={css.sectionLocationHeading}>
        ...
        <div className={css.location}>
          <svg width="10" height="13" viewBox="0 0 10 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M4.73167 12.0381L4.7725 12.0614L4.78883 12.0708C4.8536 12.1058 4.92608 12.1241 4.99971 12.1241C5.07334 12.1241 5.14581 12.1058 5.21058 12.0708L5.22692 12.062L5.26833 12.0381C5.49648 11.9028 5.71911 11.7584 5.93567 11.6053C6.49629 11.2094 7.02011 10.7639 7.50075 10.2741C8.63475 9.11325 9.8125 7.36908 9.8125 5.125C9.8125 3.84865 9.30547 2.62457 8.40295 1.72205C7.50043 0.81953 6.27635 0.3125 5 0.3125C3.72365 0.3125 2.49957 0.81953 1.59705 1.72205C0.69453 2.62457 0.1875 3.84865 0.1875 5.125C0.1875 7.3685 1.36583 9.11325 2.49925 10.2741C2.97971 10.7639 3.50333 11.2094 4.06375 11.6053C4.2805 11.7584 4.50332 11.9028 4.73167 12.0381ZM5 6.875C5.46413 6.875 5.90925 6.69063 6.23744 6.36244C6.56563 6.03425 6.75 5.58913 6.75 5.125C6.75 4.66087 6.56563 4.21575 6.23744 3.88756C5.90925 3.55937 5.46413 3.375 5 3.375C4.53587 3.375 4.09075 3.55937 3.76256 3.88756C3.43437 4.21575 3.25 4.66087 3.25 5.125C3.25 5.58913 3.43437 6.03425 3.76256 6.36244C4.09075 6.69063 4.53587 6.875 5 6.875Z" fill="#818181" />
          </svg>
      ...
      <section className={css.sectionDetails}>
        ...
        <ul className={css.detailsType}>
          {existingListingFields.map(detail => detail.key === 'bedrooms' || detail.key === 'bathrooms' ? (
            <li key={detail.key} className={css.detailsTypeRow}>
              {detail.key === 'bedrooms' ? <IconCollection name="bed_icon" /> : <IconCollection name="bathroom_icon" />}
              <span>
                <span className={css.detailTypeValue}> {detail.value} &nbsp;</span>
